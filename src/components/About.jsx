        ...
        <section ref={sectionRef} className="h-screen relative overflow-hidden bg-gradient-to-b from-black to-[#9a74cf50] ">
            ...
            >
                <h3 className='text-sm md:text-2xl font-bold text-purple-200 z-50 lg:max-w-[45rem] max-w-[20rem] tracking-wider md:mt-20 sm:mt-[-40rem] mt-[-32rem]'>
                    ...
                    I specialize in building responsive, user-friendly applications and delivering efficient, innovative solutions. 
                    Always eager to learn, I strive to contribute to impactful projects.
                </h3>
                <img 
            ...
            <div className="absolute bottom-0 w-full flex justify-center items-center py-10">
                <Slider width="120px" height="75px" reverse={false} />
            </div>
        </section>
    );
};
